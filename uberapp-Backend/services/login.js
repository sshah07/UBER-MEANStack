...
//var password = bcrypt.hashSync(msg.password);
	  ...
	  set = {c_firstname:firstname,c_lastname:lastname,c_emailid:email,c_password:password,c_creditcard:creditnumber,c_cvv:creditcvv,c_phone:mobile,c_ssn:ssn,C_address:address,c_city:city,c_state:state,c_zipcode:zipcode,c_creditmonth:creditmonth,c_credityear:credityear}
...
function handle_request_login(msg,callback)
{
	...
	var findCustomer = "select * from customer_signup where c_emailid='"+c_email+"' and c_password='"+c_password+"'";
